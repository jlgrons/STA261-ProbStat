...
All tests will be closed book and aid sheets will not be allowed. The tests will cover all material in lecture up to that point, with an emphasis on the material from the last exam for tests 2 and 3. Tests may include proofs. 
...
Students needing to take a deferred final exam from a previous semester are to take Term Test 3.
