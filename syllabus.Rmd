...
The mark for this course is based on three exams. The first two exams will take place during the semester and the final exam will be during the Final Exam period. The tests will cover all material in lecture up to that point, with an emphasis on the material from the last exam for the second and third tests. Tests may include proofs. All tests will be closed book and aid sheets will not be allowed. 

Provided you take all three tests (T1, T2, and T3), your final grade will be calculated as:

max(30% * max(T1, T2) + 70% * T3, 70% * max(T1, T2) + 30% * T3).

If you miss either test 1 or test 2, your final grade will be calculated using the completed test 1/2 (completed T1/T2) and the final test: 

max(30% * completed T1/T2 + 70% * T3, 70% * completed T1/T2 + 30% * T3).

If you miss both test 1 and test 2, your grade will be based on final test alone.
...
Students needing to take a deferred final exam from a previous semester are to take the test during the final exam period. 
...
You must send your completed documentation to the course email before the scheduled exam time to be excused from the test. Documentation cannot be submitted after a student takes an exam and the exam will not be excused.

If you are excused from one test, your final grade will be calculated using the remaining two tests (i.e., no make-up exams will be offered). If two tests are missed, the instructor may either conduct an oral exam or base your final grade on the single completed test, at her discretion. University policies on deferring the final test can be found [here](https://www.artsci.utoronto.ca/current/faculty-registrar/petitions/deferred-exams).  
